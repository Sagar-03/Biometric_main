...
def fetch_mongo_data():
    ...
    results = attendance_collection.find({"date": today})

    synced_count = results.count() if results else 0

    return {"message": f"MongoDB Attendance Sync Completed", "total_records": synced_count}
